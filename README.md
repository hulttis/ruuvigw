...
| `ADFIELDS`: [object]                                         | home assistant auto discovery fields (default: see ruuvigw.json)              |
...
| &nbsp;&nbsp;&nbsp;`<ruuvitag field>`: [string] | ruuvigw field name used for InfluxDB / MQTT                                                        |
